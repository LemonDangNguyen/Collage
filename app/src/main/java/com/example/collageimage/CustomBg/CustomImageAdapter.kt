...
class CustomImageAdapter(
    private val images: List<CustomImage>,
    private val onClick: (CustomImage) -> Unit
) : RecyclerView.Adapter<CustomImageAdapter.ViewHolder>() {

    inner class ViewHolder(private val binding: ItemCustomBgImageBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemCustomBgImageBinding.inflate(LayoutInflater.from(parent.context), parent, false)
