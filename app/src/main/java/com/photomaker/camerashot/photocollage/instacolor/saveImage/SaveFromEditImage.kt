package com.photomaker.camerashot.photocollage.instacolor.saveImage
...
import com.photomaker.camerashot.photocollage.instacolor.databinding.ActivitySaveFromEditImageBinding
        ...
        if (haveNetworkConnection() && ConsentHelper.getInstance(this).canRequestAds()
            ...
            Admob.getInstance().showInterAds(this@SaveFromEditImage, AdsConfig.interBack, object : AdCallback() {
                override fun onNextAction() {
                    super.onNextAction()
                    val intent = Intent(this@SaveFromEditImage, MainActivity::class.java)
